...
for batch_size in batch_sizes:
    ...
    checkpoint_path = 'checkpoints/best_model_0111_four_layers_bilstm_segementation_5frames_{}.h5'.format(batch_size)
    ...
    model.save('0111_four_layers_bilstm_segementation_5frames_32.h5')
    # 儲存損失
    ...
    if not os.path.exists('plots'):
        os.makedirs('plots')
    img_path = "plots/0111_four_layers_bilstm_segementation_5frames__{}.png".format(batch_size)
...
if not os.path.exists('plots'):
    os.makedirs('plots')
plt.savefig('plots/0111_four_layers_bilstm_segementation_5frames_.png')
plt.show()
